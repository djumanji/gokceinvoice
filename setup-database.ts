...
const migrations = [
  ...
  '005_email_verification_and_reset.sql',
  '006_add_name_field_to_users.sql',
  '007_add_bank_accounts_table.sql',
  '008_add_bank_account_id_to_invoices.sql',
  '009_add_company_logo.sql',
  '010_add_projects_table.sql',
  '011_add_company_size.sql',
  '012_add_industry.sql',
  '013_add_leads_system.sql',
  '014_add_chatbot_tables.sql',
  '015_add_needed_at_to_leads.sql',
  '016_add_invoice_scheduling.sql',
  '017_add_prospect_system.sql',
];
